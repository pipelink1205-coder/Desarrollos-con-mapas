-- OBSOLETO: usar sql/10-unificar-coordenadas.sql (elimina columnas *_verdadera).
-- Priorizar latitud/longitud editadas en Admin sobre columnas legacy del CSV.
-- Ejecutar en Supabase SQL Editor después de 05-catalogos-oferta.sql.
...
SELECT
  ...
  END                  AS d,
  COALESCE(i.latitud, i.latitud_verdadera)   AS lat,
  COALESCE(i.longitud, i.longitud_verdadera) AS lon,
  i.comuna             AS c,
  i.barrio,
  i.telefono           AS tel,
  i.email,
